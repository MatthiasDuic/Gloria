...
// gpt-4.1-mini liefert stabiles JSON in typisch 400–900 ms und folgt unseren
// langen, regelreichen System-Prompts (Phasen-Disziplin, Anti-Floskel,
// Datum-Lock, Wiedervorlage-Recap) deutlich treuer als gpt-4o-mini.
// Default für Voice. Wer bewusst gpt-4o oder gpt-5 testen will,
// setzt OPENAI_MODEL in der Umgebung.
export const AI_CONFIG = {
  chatModel: configuredChatModel || "gpt-4.1-mini",
