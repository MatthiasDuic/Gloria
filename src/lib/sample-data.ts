...
const PKV_OBJECTIONS = [
  ...
  "",
  "\"Zu teuer\" → Genau deshalb schauen wir gemeinsam drauf. Nicht der heutige Beitrag ist das eigentliche Thema – sondern wie er sich entwickelt. Und genau das ist planbar, wenn man früh genug die Handlungsmöglichkeiten kennt.",
  "",
  ...
  "",
  "\"Zu jung / zu alt\" → Im Gegenteil: Je früher man die Beitragsentwicklung kennt, desto mehr Handlungsmöglichkeiten hat man. Und auch später im Berufsleben gibt es noch sinnvolle Optimierungen, gerade Richtung Ruhestand.",
  "",
