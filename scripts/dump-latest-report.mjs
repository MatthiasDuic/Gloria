...
const r = (reports.json?.reports || []).find((x) => x.callSid === process.argv[2]) || reports.json?.reports?.[0];
if (!r) { console.log("Kein Report gefunden"); process.exit(0); }
console.log("=== Report ===");
console.log("SID:", r.callSid, "| outcome:", r.outcome, "| at:", r.createdAt);
console.log("\n--- summary ---");
